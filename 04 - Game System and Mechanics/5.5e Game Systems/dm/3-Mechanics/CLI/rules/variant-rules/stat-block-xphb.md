...
A stat block contains the game statistics of a [monster](monster-xphb.md). Each stat block includes the following information presented after the [monster's](monster-xphb.md) name.
