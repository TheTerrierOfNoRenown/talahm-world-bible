...
|------------|--------------|
| 1 | You pass through a [Swarm of Insects](3-Mechanics/CLI/bestiary/beast/swarm-of-insects-xmm.md) (see the "Monster Manual", with the DM choosing whichever kind of insects makes the most sense). The swarm uses one of its actions, targeting you. |
