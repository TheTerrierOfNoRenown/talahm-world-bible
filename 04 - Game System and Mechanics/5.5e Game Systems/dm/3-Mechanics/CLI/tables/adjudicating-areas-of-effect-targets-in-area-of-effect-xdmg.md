...
*Use this column for [Cylinders](cylinder-area-of-effect-xphb.md), [Emanations](emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](sphere-area-of-effect-xphb.md).