...
| dice: 1d100 | Effect |
|-------------|--------|
| 01-20 | You cast a spell originating from the chosen point. Roll `1d10` to determine the spell: on a **1-2**, [Darkness](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/spells/darkness-xphb.md); on a **3-4**, [Faerie Fire](faerie-fire-xphb.md); on a **5-6**, [Fireball](3-Mechanics/CLI/spells/fireball-xphb.md); on a **7-8**, [Slow](3-Mechanics/CLI/spells/slow-xphb.md); on a **9-10**, [Stinking Cloud](stinking-cloud-xphb.md). |
...
| 26-30 | You cast [Gust of Wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md). The [Line](line-area-of-effect-xphb.md) created by the spell extends from you to the chosen point of origin. |
...
| 46-50 | You cast [Lightning Bolt](lightning-bolt-xphb.md). The [Line](line-area-of-effect-xphb.md) created by the spell extends from you to the chosen point of origin. |
...
| 78-82 | Nothing happens at the chosen point of origin. Instead, a burst of colorful, shimmering light extends from you in a 30-foot [Emanation](emanation-area-of-effect-xphb.md). Each creature in the area must succeed on a DC 15 Constitution saving throw or have the [Blinded](conditions.md#Blinded) condition for 1 minute. A creature repeats the save at the end of each of its turns, ending the effect on itself on a success. |
| 83-87 | Nothing happens at the chosen point of origin. Instead, you cast [Invisibility](invisibility-xphb.md) on yourself. |
| 88-92 | Nothing happens at the chosen point of origin. Instead, a stream of `1d4 × 10` gems, each worth 1 GP, shoots from the wand's tip in a [Line](line-area-of-effect-xphb.md) 30 feet long and 5 feet wide toward the chosen point of origin. Each gem deals 1 Bludgeoning damage, and the total damage of the gems is divided equally among all creatures in the [Line](line-area-of-effect-xphb.md). |
| 93-97 | You cast [Polymorph](polymorph-xphb.md), targeting the creature closest to the chosen point of origin. Roll `1d4` to determine the target's new form. On a **1**, the new form is a [Black Bear](black-bear-xmm.md); on a **2**, the new form is a [Giant Wasp](3-Mechanics/CLI/bestiary/beast/giant-wasp-xmm.md); on a **3-4**, the new form is a [Frog](frog-xmm.md). |
