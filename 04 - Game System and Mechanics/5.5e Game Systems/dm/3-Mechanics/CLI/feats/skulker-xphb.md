...
**Fog of War.** You exploit the distractions of battle, gaining [Advantage](advantage-xphb.md) on any Dexterity ([Stealth](skills.md#Stealth)) check you make as part of the [Hide](actions.md#Hide) action during combat.
