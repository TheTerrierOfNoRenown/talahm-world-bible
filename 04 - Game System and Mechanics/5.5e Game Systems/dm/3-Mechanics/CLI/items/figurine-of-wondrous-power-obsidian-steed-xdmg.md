...
![](3-Mechanics/CLI/items/img/figurine-of-wondrous-power-obsidian-steed.webp#right)
...
This polished obsidian horse can become a [Nightmare](3-Mechanics/CLI/bestiary/fiend/nightmare-xmm.md) for up to 24 hours. The nightmare fights only to defend itself. Once it has been used, it can't be used again until 5 days have passed.
