...
As long as it has at least one diamond, the helm emits a 30-foot [Emanation](emanation-area-of-effect-xphb.md). When at least one Undead is within that area, the [Emanation](emanation-area-of-effect-xphb.md) is filled with [Dim Light](dim-light-xphb.md). Any Undead that starts its turn in that area takes `1d6` Radiant damage.
...
As long as the helm has at least one ruby, you have [Resistance](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md) to Fire damage.

## Spells

You can cast one of the following spells (save DC 18), using one of the helm's gems of the specified type as a component: [Daylight](daylight-xphb.md) (opal), [Fireball](3-Mechanics/CLI/spells/fireball-xphb.md) (fire opal), [Prismatic Spray](prismatic-spray-xphb.md) (diamond), or [Wall of Fire](3-Mechanics/CLI/spells/wall-of-fire-xphb.md) (ruby). The gem is destroyed when the spell is cast and disappears from the helm.

## Taking Fire Damage

Roll `1d20` if you are wearing the helm and take Fire damage as a result of failing a saving throw against a spell. On a roll of 1, the helm emits beams of light from its remaining gems and is then destroyed. Each creature within a 60-foot [Emanation](emanation-area-of-effect-xphb.md) originating from you must succeed on a DC 17 Dexterity saving throw or be struck by a beam, taking Radiant damage equal to the number of gems in the helm.
