...
When you drink this potion, you gain the "enlarge" effect of the [Enlarge/Reduce](3-Mechanics/CLI/spells/enlarge-reduce-xphb.md) spell for 10 minutes (no [Concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) required).
