...
| dice: 1d100 | Effect |
|-------------|--------|
| 01-50 | You cast a random spell determined by rolling `1d10`: on a **1**, [Enlarge/Reduce](enlarge-reduce-xphb.md) (enlarge effect); on a **2**, [Enlarge/Reduce](enlarge-reduce-xphb.md) (reduce effect); on a **3**, [Faerie Fire](faerie-fire-xphb.md); on a **4**, [Fireball](3-Mechanics/CLI/spells/fireball-xphb.md); on a **5**, [Gust of Wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md); on a **6**, [Invisibility](invisibility-xphb.md) (cast on yourself); on a **7**, [Lightning Bolt](lightning-bolt-xphb.md); on an **8**, [Phantasmal Force](3-Mechanics/CLI/spells/phantasmal-force-xphb.md); on a **9**, [Polymorph](polymorph-xphb.md); on a **10**, [Stinking Cloud](stinking-cloud-xphb.md). |
