...
---
# Horn of Valhalla, Bronze
*Wondrous item, instrument ([horn](3-Mechanics/CLI/items/horn-xphb.md)), very rare*  
...
A bronze horn summons 4 [Berserkers](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md). To use the bronze horn, you must have training with all Medium armor.
