...
- **Properties**: [Finesse](item-properties.md#Finesse), [Versatile](item-properties.md#Versatile)
- **Weight**: 3.0 lbs.
...
While grasping the hilt, you can take a [Bonus Action](bonus-action-xphb.md) to cause a blade of pure radiance to spring into existence or make the blade disappear. While the blade exists, this magic weapon functions as a Longsword with [Finesse](item-properties.md#Finesse). If you are proficient with Longswords or Shortswords, you are proficient with the Sun Blade.
