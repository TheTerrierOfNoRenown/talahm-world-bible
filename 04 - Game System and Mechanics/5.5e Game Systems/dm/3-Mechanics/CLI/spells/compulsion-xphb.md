...
For the duration, you can take a [Bonus Action](bonus-action-xphb.md) to designate a direction that is horizontal to you. Each [Charmed](conditions.md#Charmed) target must use as much of its movement as possible to move in that direction on its next turn, taking the safest route. After moving in this way, a target repeats the save, ending the spell on itself on a success.

**Classes**: [Bard](list-spells-classes-bard.md); [Paladin (Oath of Glory)](list-spells-classes-oath-of-glory-xphb.md "subclass=XPHB;class=XPHB")
