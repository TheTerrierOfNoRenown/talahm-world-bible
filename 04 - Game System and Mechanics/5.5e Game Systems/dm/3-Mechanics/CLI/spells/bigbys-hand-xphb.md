...
The hand is an object that has AC 20 and [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) equal to your [Hit Point](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) maximum. If it drops to 0 [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md), the spell ends. The hand doesn't occupy its space.
