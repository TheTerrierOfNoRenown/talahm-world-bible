...
**Classes**: [Bard](list-spells-classes-bard.md); [Cleric (Trickery Domain)](list-spells-classes-trickery-domain-xphb.md "subclass=XPHB;class=XPHB"); [Sorcerer](list-spells-classes-sorcerer.md); [Warlock (Archfey Patron)](list-spells-classes-archfey-patron-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
