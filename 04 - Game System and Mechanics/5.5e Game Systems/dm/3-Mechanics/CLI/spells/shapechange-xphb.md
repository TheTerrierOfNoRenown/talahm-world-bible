...
When you cast the spell, you gain a number of [Temporary Hit Points](temporary-hit-points-xphb.md) equal to the [Hit Points](hit-points-xphb.md) of the first form into which you shape-shift. These [Temporary Hit Points](temporary-hit-points-xphb.md) vanish if any remain when the spell ends.
...
**Classes**: [Bard](list-spells-classes-bard.md); [Druid](list-spells-classes-druid.md); [Wizard](list-spells-classes-wizard.md)
