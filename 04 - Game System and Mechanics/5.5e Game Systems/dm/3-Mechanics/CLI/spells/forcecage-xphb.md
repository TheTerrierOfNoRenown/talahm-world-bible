...
An immobile, [Invisible](conditions.md#Invisible), [Cube](cube-area-of-effect-xphb.md)-shaped prison composed of magical force springs into existence around an area you choose within range. The prison can be a cage or a solid box, as you choose.
...
**Classes**: [Bard](list-spells-classes-bard.md); [Warlock](list-spells-classes-warlock.md); [Wizard (Evoker)](list-spells-classes-evoker-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
