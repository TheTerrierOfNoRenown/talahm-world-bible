...
**Classes**: [Bard](list-spells-classes-bard.md); [Druid](list-spells-classes-druid.md); [Ranger](list-spells-classes-ranger.md); [Sorcerer](list-spells-classes-sorcerer.md); [Warlock (Archfey Patron)](list-spells-classes-archfey-patron-xphb.md "subclass=XPHB;class=XPHB")
