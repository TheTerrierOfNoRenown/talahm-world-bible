...
Swarming locusts fill a 20-foot-radius [Sphere](sphere-area-of-effect-xphb.md) centered on a point you choose within range. The [Sphere](sphere-area-of-effect-xphb.md) remains for the duration, and its area is [Lightly Obscured](lightly-obscured-xphb.md) and [Difficult Terrain](difficult-terrain-xphb.md).
...
**Classes**: [Bard](list-spells-classes-bard.md); [Cleric](list-spells-classes-cleric.md); [Druid (Circle of the Land, Tropical Land)](list-spells-classes-circle-of-the-land-xphb.md "subclass=XPHB;class=XPHB"); [Druid](list-spells-classes-druid.md); [Sorcerer](list-spells-classes-sorcerer.md); [Warlock (Fiend Patron)](list-spells-classes-fiend-patron-xphb.md "subclass=XPHB;class=XPHB")
