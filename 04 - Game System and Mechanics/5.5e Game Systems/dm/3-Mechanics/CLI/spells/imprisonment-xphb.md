...
A [Dispel Magic](dispel-magic-xphb.md) spell can end the spell only if it is cast with a level 9 spell slot, targeting either the prison or the component used to create it.

## Summary

**Classes**: [Bard](list-spells-classes-bard.md); [Warlock](list-spells-classes-warlock.md); [Wizard (Abjurer)](list-spells-classes-abjurer-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
