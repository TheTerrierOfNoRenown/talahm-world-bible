...
**Classes**: [Bard](list-spells-classes-bard.md); [Cleric](list-spells-classes-cleric.md); [Paladin (Oath of Devotion)](list-spells-classes-oath-of-devotion-xphb.md "subclass=XPHB;class=XPHB"); [Warlock (Celestial Patron)](list-spells-classes-celestial-patron-xphb.md "subclass=XPHB;class=XPHB")
