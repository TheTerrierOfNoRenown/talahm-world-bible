...
A [Remove Curse](remove-curse-xphb.md), [Greater Restoration](greater-restoration-xphb.md), or [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell ends this spell.
...
**Classes**: [Bard](list-spells-classes-bard.md); [Cleric](list-spells-classes-cleric.md); [Druid](list-spells-classes-druid.md); [Paladin](list-spells-classes-paladin.md); [Warlock (Fiend Patron)](list-spells-classes-fiend-patron-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
