...
- ttrpg-cli/spell/reward/reliquary-charm
...
**Classes**: [Bard](list-spells-classes-bard.md); [Cleric (Life Domain)](list-spells-classes-life-domain-xphb.md "subclass=XPHB;class=XPHB"); [Cleric](list-spells-classes-cleric.md); [Druid](list-spells-classes-druid.md); [Paladin](list-spells-classes-paladin.md); [Ranger](list-spells-classes-ranger.md); [Sorcerer (Clockwork Sorcery)](list-spells-classes-clockwork-sorcery-xphb.md "subclass=XPHB;class=XPHB"); [Warlock (Celestial Patron)](list-spells-classes-celestial-patron-xphb.md "subclass=XPHB;class=XPHB")
