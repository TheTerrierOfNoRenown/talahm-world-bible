...
**Classes**: [Bard](list-spells-classes-bard.md); [Cleric](list-spells-classes-cleric.md); [Paladin (Oath of Glory)](list-spells-classes-oath-of-glory-xphb.md "subclass=XPHB;class=XPHB"); [Sorcerer (Draconic Sorcery)](list-spells-classes-draconic-sorcery-xphb.md "subclass=XPHB;class=XPHB"); [Wizard (Diviner)](list-spells-classes-diviner-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
