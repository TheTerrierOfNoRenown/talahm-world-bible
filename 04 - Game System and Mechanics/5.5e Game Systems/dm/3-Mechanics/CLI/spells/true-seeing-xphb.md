...
**Classes**: [Bard](list-spells-classes-bard.md); [Cleric](list-spells-classes-cleric.md); [Sorcerer](list-spells-classes-sorcerer.md); [Warlock](list-spells-classes-warlock.md); [Wizard (Diviner)](list-spells-classes-diviner-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
