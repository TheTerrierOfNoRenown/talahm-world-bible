...
You pull wisps of shadow material from the Shadowfell to create an object within range. It is either an object of vegetable matter (soft goods, rope, wood, and the like) or mineral matter (stone, crystal, metal, and the like). The object must be no larger than a 5-foot [Cube](cube-area-of-effect-xphb.md), and the object must be of a form and material that you have seen.
...
**Using a Higher-Level Spell Slot.** The [Cube](cube-area-of-effect-xphb.md) increases by 5 feet for each spell slot level above 5.

**Classes**: [Bard](list-spells-classes-bard.md); [Sorcerer](list-spells-classes-sorcerer.md); [Wizard (Illusionist)](list-spells-classes-illusionist-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
