...
The Workshop comes equipped with six different kinds of [Artisan's Tools](artisans-tools-xphb.md), chosen from the following list:
...
After spending an entire [Short Rest](short-rest-xphb.md) in your Workshop, you gain [Heroic Inspiration](heroic-inspiration-xphb.md). You can't gain this benefit again until you finish a [Long Rest](long-rest-xphb.md).

## Enlarging the Facility

You can enlarge your Workshop to a Vast facility by spending 2,000 GP. If you do so, the Workshop gains two additional hirelings and three additional [Artisan's Tools](artisans-tools-xphb.md) (chosen from the list above).
