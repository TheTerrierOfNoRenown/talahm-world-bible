...
|--------------|----------------|
| Battle Expert | When you take damage from an attack made with an [Unarmed Strike](unarmed-strike-xphb.md) or a weapon, you can take a [Reaction](reaction-xphb.md) to reduce this damage by `1d4`. |
...
| Weapon Expert | Choose a kind of Simple or Martial weapon, such as [Spear](spear-xphb.md) or [Longbow](3-Mechanics/CLI/items/longbow-xphb.md). If you aren't proficient with the weapon, you gain proficiency with it. If you already have proficiency with the weapon, you can use its mastery property. |
^expert-trainers
