...
| Creature | Size | Cost |
|----------|------|------|
| [Ape](ape-xmm.md) | Medium | 500 GP |
| [Black Bear](black-bear-xmm.md) | Medium | 500 GP |
| [Brown Bear](brown-bear-xmm.md) | Large | 1,000 GP |
| [Constrictor Snake](constrictor-snake-xmm.md) | Large | 250 GP |
| [Crocodile](3-Mechanics/CLI/bestiary/beast/crocodile-xmm.md) | Large | 500 GP |
| [Dire Wolf](dire-wolf-xmm.md) | Large | 1,000 GP |
...
With the DM's consent, you can add different creatures than those shown in the Menagerie Creatures table to your Menagerie. The cost of a creature depends on its [Challenge Rating](challenge-rating-xphb.md), as shown on the Creature Costs by Challenge Rating table. Typically only Beasts and some Monstrosities can be kept in a Menagerie, though the DM might allow other creatures.
