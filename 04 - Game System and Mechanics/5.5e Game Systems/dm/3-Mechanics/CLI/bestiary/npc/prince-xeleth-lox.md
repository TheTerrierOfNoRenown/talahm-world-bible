...
![[prince-xeleth-lox.webp]]

```statblock
"name": "Prince Xeleth (LoX)"
"size": "Medium"
"type": "humanoid"
"subtype": "wizard"
...
"cr": "8"
"traits":
  - "desc": "Xeleth has advantage on saving throws it makes to avoid or end the [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
      \ condition on itself, and magic can't put it to sleep."
    "name": "Fey Ancestry"
  - "desc": "Xeleth wears a suit of [elven chain](3-Mechanics/CLI/items/elven-chain-xdmg.md)."
    "name": "Special Equipment"
  - "desc": "Xeleth doesn't require sleep."
    "name": "Unusual Nature"
"actions":
...
"source":
  - "LoX"
"image": "3-Mechanics/CLI/bestiary/npc/token/prince-xeleth-lox.webp"
```
^statblock
