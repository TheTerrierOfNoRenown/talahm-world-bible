...
"actions":
  ...
  - "desc": "Each non-undead creature within 60 feet of Agony that can see it must\
      ...
      \ next 24 hours. The aging effect can be reversed with a  [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md)\
...
"source":
  - "LoX"
"image": "3-Mechanics/CLI/bestiary/npc/token/agony-lox.webp"
```
^statblock
