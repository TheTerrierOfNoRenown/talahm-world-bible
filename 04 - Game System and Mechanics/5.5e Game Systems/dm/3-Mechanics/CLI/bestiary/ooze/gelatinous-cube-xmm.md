...
"traits":
  - "desc": "The cube fills its entire space and is transparent. Other creatures can\
      ...
      \ 12 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check,\
...
"actions":
  ...
  - "desc": "The cube moves up to its [Speed](3-Mechanics/CLI/rules/variant-rules/speed-xphb.md)\
      ...
      \ room inside itself to contain them (see the Ooze [Cube](3-Mechanics/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\
      ...
      \ spells with a Verbal component, has the [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
      ...
      \ target can try to escape by taking an action to make a DC 12 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics))\
