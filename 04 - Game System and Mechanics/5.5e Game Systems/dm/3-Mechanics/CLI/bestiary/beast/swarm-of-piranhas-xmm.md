...
"actions":
  - "desc": "*Melee Attack Roll:* +5 (with [Advantage](3-Mechanics/CLI/rules/variant-rules/advantage-xphb.md)\
      ...
      \ damage if the swarm is [Bloodied](3-Mechanics/CLI/rules/conditions.md#Bloodied)."
    "name": "Bites"
"source":
  - "XMM"
"image": "3-Mechanics/CLI/bestiary/beast/token/swarm of piranhas.webp"
```
^statblock
