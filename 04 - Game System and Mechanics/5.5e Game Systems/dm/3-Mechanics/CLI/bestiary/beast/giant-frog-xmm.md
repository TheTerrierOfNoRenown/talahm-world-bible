...
"actions":
  ...
  - "desc": "The frog swallows a Small or smaller target it is grappling. While swallowed,\
      \ the target isn't [Grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
      \ but has the [Blinded](3-Mechanics/CLI/rules/conditions.md#Blinded) and [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
      ...
      \ longer [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) and can\
      \ escape from the corpse using 5 feet of movement, exiting with the [Prone](3-Mechanics/CLI/rules/conditions.md#Prone)\
      ...
      \ it, causing it to exit [Prone](3-Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Swallow"
"source":
  - "XMM"
