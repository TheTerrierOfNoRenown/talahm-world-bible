...
"traits":
  ...
  - "desc": "The arcanaloth has a magic tome. While holding or carrying the tome,\
      ...
      \ 35; and [Immunity](3-Mechanics/CLI/rules/variant-rules/immunity-xphb.md) to\
      \ Necrotic, Poison, and Psychic damage. The tome regains all its [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ create a new one when it finishes a [Short](3-Mechanics/CLI/rules/variant-rules/short-rest-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 10 (2d4 + 5) Slashing\
      ...
      \ to the tome and can escape only if the tome is reduced to 0 [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)."
