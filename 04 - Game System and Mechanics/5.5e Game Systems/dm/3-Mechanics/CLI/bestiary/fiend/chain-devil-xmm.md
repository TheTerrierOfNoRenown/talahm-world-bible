...
"actions":
  ...
  - "desc": "The devil conjures a fiery chain to bind a creature. *Dexterity Saving\
      ...
      \ (2d4 + 4) Fire damage, and the target has the [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
...
"reactions":
  - "desc": "Trigger: A creature the devil can see starts its turn within 30 feet\
      ...
      \ the triggering creature. *Failure:* The target has the [Frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)\
