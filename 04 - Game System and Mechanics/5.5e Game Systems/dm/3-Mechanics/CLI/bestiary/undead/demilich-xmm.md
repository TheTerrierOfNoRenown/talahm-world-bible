...
"traits":
  ...
  - "desc": "If the demilich is destroyed, it reforms and regains all its [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
      \ in 1d10 days unless a [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell\
...
"regional_effects":
  - "desc": "The region containing a demilich's lair is twisted by its presence, creating\
      ...
      \ than the demilich or one of its allies finishes a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md)\
      ...
      \ a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md) outside\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 19, one creature the demilich can see\
      \ within 120 feet. *Failure:* The target's [Hit Point](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The demilich flies up to its [Fly Speed](3-Mechanics/CLI/rules/variant-rules/fly-speed-xphb.md),\
      ...
      \ 19. *Failure:* The target has the [Blinded](3-Mechanics/CLI/rules/conditions.md#Blinded)\
