...
"traits":
  ...
  - "desc": "Undead creatures of the death knight's choice (excluding itself) in a\
      \ 60-foot [Emanation](3-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the death knight can\
      ...
      \ [Hit Point](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) maximum\
