...
A death tyrant is a beholder that pursues aberrant goals beyond its death. Ten magical singularitiesâ€”all that remains of its magical eyesâ€”orbit its floating, cyclopean skull, while the hateful gaze of its central eye socket stifles life and raises the dead.
...
"actions":
  ...
  - "desc": "The death tyrant randomly shoots one of the following magical rays at\
      ...
      \ target has the [Charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) condition\
      ...
      \ take Reactions; its [Speed](3-Mechanics/CLI/rules/variant-rules/speed-xphb.md)\
      ...
      \ has the [Incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      ...
      \ if it is a Construct or an Undead). *Failure:* The target has the [Unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious)\
...
"regional_effects":
  - "desc": "The region containing a death tyrant's lair is warped by its presence,\
      ...
      \ a creature within 1 mile of the lair regains [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ allies) that finishes a [Short Rest](3-Mechanics/CLI/rules/variant-rules/short-rest-xphb.md)\
