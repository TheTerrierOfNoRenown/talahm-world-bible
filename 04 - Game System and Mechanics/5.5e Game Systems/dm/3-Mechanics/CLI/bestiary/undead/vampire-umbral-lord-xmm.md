...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ inside its resting place, it has the [Paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the vampire can see\
      ...
      \ Necrotic damage. The target's [Hit Point](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
