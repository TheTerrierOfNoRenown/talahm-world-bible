...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 15, one creature the revenant can see within\
      ...
      \ If the [Frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) target\
      \ is cursed by the revenant (see Vow of Revenge), the target also has the [Paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
"bonus_actions":
  - "desc": "The revenant curses one creature it can see within 30 feet of itself.\
      ...
      \ the revenant uses this [Bonus Action](3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md)\
