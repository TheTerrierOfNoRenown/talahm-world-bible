...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, one creature the banshee can see within\
      \ 60 feet that can see the banshee. *Failure:* The target has the [Frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)\
  ...
  - "desc": "The banshee releases a mournful wail if it isn't in sunlight. *Constitution\
      ...
      \ and isn't a Construct or an Undead. *Failure:* If the target has 25 [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md)\
