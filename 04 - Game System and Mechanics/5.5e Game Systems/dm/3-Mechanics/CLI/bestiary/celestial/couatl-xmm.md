...
Each couatl goes through a period of renewal at the end of an age. In a couatl's lifecycle, an age might correspond to a celestial calendar or some divine chronology. Near the age's end, the couatl lays a wondrous, rainbow-hued egg. When the age ends, the couatl dies. For a periodâ€”perhaps a single day, perhaps until an annual solar eventâ€”the couatl's work is unattended. Once this time passes, the same couatl that laid the egg hatches from it, fully grown and renewed to serve for another age.
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, one Medium or smaller creature the couatl\
      ...
      \ (escape DC 13), and it has the [Restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
