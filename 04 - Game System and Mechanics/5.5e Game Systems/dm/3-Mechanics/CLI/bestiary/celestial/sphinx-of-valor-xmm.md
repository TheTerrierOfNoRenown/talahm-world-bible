...
"actions":
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      \ [Heroes' Feast](3-Mechanics/CLI/spells/heroes-feast-xphb.md), [Zone of Truth](3-Mechanics/CLI/spells/zone-of-truth-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing a sphinx of lore's or sphinx of valor's lair is\
      ...
      \ While in its lair, the sphinx can cast [Clairvoyance](3-Mechanics/CLI/spells/clairvoyance-xphb.md),\
      ...
      \ a [Study](3-Mechanics/CLI/rules/actions.md#Study) action while within 1 mile\
