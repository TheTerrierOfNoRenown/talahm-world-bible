...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, each creature in the elemental's space.\
      ...
      \ smaller creature, it has the [Grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
      ...
      \ can pull a creature out of it by succeeding on a DC 14 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics))\
