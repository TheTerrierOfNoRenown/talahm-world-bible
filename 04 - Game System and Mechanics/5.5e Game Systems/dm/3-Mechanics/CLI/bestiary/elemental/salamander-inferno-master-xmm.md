...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 30-foot-radius [Sphere](3-Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ the normal [burning](3-Mechanics/CLI/traps-hazards/burning-xphb.md) damage.\
      \ The target gains 1 [Exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion)\
      \ level whenever it takes this [burning](3-Mechanics/CLI/traps-hazards/burning-xphb.md)\
...
"bonus_actions":
  - "desc": "The salamander moves up to its [Speed](3-Mechanics/CLI/rules/variant-rules/speed-xphb.md)\
      ...
      \ During this movement, fire fills a 5-foot [Emanation](3-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
