...
Spies gather information and disseminate lies, manipulating people to gain the results the spies' patrons desire. They're trained to manipulate, infiltrate, andâ€”when necessaryâ€”escape in a hurry. Many adopt disguises, aliases, or code names to maintain anonymity. Roll on or choose a result from the Spy Personas table to inspire a spy's disguise.
...
"actions":
  ...
  - "desc": "The spy throws a bomb to a point it can see within 30 feet of itself.\
      \ *Constitution Saving Throw:* DC 16, each creature in a 20-foot-radius [Sphere](3-Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md)\
