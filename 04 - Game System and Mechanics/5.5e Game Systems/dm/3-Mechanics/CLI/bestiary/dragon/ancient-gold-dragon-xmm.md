...
"regional_effects":
  - "desc": "The region containing an adult or ancient gold dragon's lair is altered\
      ...
      \ While in its lair, the dragon can cast [Dream](3-Mechanics/CLI/spells/dream-xphb.md),\
      ...
      \ Obscured](3-Mechanics/CLI/rules/variant-rules/lightly-obscured-xphb.md) by\
      \ opalescent fog. While in that area, creatures can't be [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised),\
