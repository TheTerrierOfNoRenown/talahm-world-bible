...
"regional_effects":
  - "desc": "The region containing an adult or ancient copper dragon's lair is changed\
      ...
      \ on a [D20 Test](3-Mechanics/CLI/rules/variant-rules/d20-test-xphb.md), it\
      \ must succeed on a DC 15 Wisdom saving throw or have the [Incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 21, one creature the dragon can see within\
      ...
      \ roll and subtracts the number rolled from the [D20 Test](3-Mechanics/CLI/rules/variant-rules/d20-test-xphb.md).\
