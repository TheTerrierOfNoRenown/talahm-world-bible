...
"regional_effects":
  - "desc": "The area containing an adult or ancient brass dragon's lair is altered\
      ...
      \ its lair, the dragon can cast [Major Image](3-Mechanics/CLI/spells/major-image-xphb.md),\
      ...
      \ refreshing. A creature that drinks such water gains 2d4 [Temporary Hit Points](3-Mechanics/CLI/rules/variant-rules/temporary-hit-points-xphb.md),\
