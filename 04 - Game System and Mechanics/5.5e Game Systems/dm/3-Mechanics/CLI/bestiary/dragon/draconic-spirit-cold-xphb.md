...
---
# [Draconic Spirit (Cold)](3-Mechanics/CLI/bestiary/dragon/draconic-spirit-cold-xphb.md)
*Source: Player's Handbook (2024) p. 325. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
![[draconic-spirit-cold-xphb.webp]]

```statblock
"name": "Draconic Spirit (Cold) (XPHB)"
"size": "Large"
"type": "dragon"
"alignment": "Neutral"
...
"traits":
  - "desc": "You have Resistance to Cold damage until the spell ends."
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC equals your spell save DC, each creature\
      \ in a 30-foot Cone. *Failure:* 2d6 Cold damage. *Success:* Half damage."
    "name": "Breath Weapon"
"source":
  - "XPHB"
```
