...
|-----------|-------------------------------------|
| 1 | An acres-large clonal colonyâ€”a stand of identical, interconnected trees. |
| 2 | A fortress-like tree, like a baobab or sequoia. |
| 3 | A living lockâ€”a plant that seals evil below or blocks the path to a dungeon. |
