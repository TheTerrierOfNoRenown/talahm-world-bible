...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 6 (1d6 + 3) Bludgeoning\
      ...
      \ its attack rolls. Its [Speed](3-Mechanics/CLI/rules/variant-rules/speed-xphb.md)\
      \ becomes 0, it can't benefit from any bonus to its [Speed](3-Mechanics/CLI/rules/variant-rules/speed-xphb.md),\
  ...
  - "desc": "Magical [Darkness](3-Mechanics/CLI/rules/variant-rules/darkness-xphb.md)\
      ...
      \ [Concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) on it,\
      \ up to 10 minutes. Darkvision can't penetrate this area, and no light can illuminate\
      \ it."
    "name": "Darkness Aura (1/Day)"
"source":
  - "XMM"
"image": "3-Mechanics/CLI/bestiary/aberration/token/darkmantle.webp"
```
^statblock
