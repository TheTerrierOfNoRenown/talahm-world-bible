...
Gricks are wormlike predators that burst from hidingâ€”flailing and snappingâ€”to consume whatever prey passes near. They hide in cavernous crags or amid deadfalls, the scattered bones and possessions of past meals the only evidence of their threat.
...
"source":
  - "XMM"
"image": "3-Mechanics/CLI/bestiary/aberration/token/grick.webp"
```
^statblock
