...
You always have the [Counterspell](3-Mechanics/CLI/spells/counterspell-xphb.md) and [Dispel Magic](dispel-magic-xphb.md) spells prepared. In addition, you can cast [Dispel Magic](dispel-magic-xphb.md) as a [Bonus Action](bonus-action-xphb.md), and you can add your [Proficiency Bonus](proficiency-xphb.md) to its ability check.
...
You have [Advantage](advantage-xphb.md) on saving throws against spells, and you have [Resistance](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md) to the damage of spells.