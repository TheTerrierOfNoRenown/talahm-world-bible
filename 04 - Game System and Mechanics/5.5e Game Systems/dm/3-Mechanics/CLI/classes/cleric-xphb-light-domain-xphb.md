...
|--------------|-----------------|
| 3rd | [Burning Hands](3-Mechanics/CLI/spells/burning-hands-xphb.md), [Faerie Fire](faerie-fire-xphb.md), [Scorching Ray](scorching-ray-xphb.md), [See Invisibility](see-invisibility-xphb.md) |
| 5th | [Daylight](daylight-xphb.md), [Fireball](3-Mechanics/CLI/spells/fireball-xphb.md) |
| 7th | [Arcane Eye](3-Mechanics/CLI/spells/arcane-eye-xphb.md), [Wall of Fire](3-Mechanics/CLI/spells/wall-of-fire-xphb.md) |
| 9th | [Flame Strike](flame-strike-xphb.md), [Scrying](3-Mechanics/CLI/spells/scrying-xphb.md) |
^light-domain-spells

### Radiance of the Dawn (Level 3)

As a [Magic](actions.md#Magic) action, you present your [Holy Symbol](holy-symbol-xphb.md) and expend a use of your Channel Divinity to emit a flash of light in a 30-foot [Emanation](emanation-area-of-effect-xphb.md) originating from yourself. Any magical [Darkness](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/rules/variant-rules/darkness-xphb.md)—such as that created by the [Darkness](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/spells/darkness-xphb.md) spell—in that area is dispelled. Additionally, each creature of your choice in that area must make a Constitution saving throw, taking Radiant damage equal to `2d10` plus your Cleric level on a failed save or half as much damage on a successful one.
...
You regain all expended uses of your Warding Flare when you finish a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md).
