...
The first time you do so, you suffer no adverse effect. If you use this feature again before you finish a [Long Rest](long-rest-xphb.md), you take `2d12` Necrotic damage for each level of the spell slot immediately after you cast it. This damage ignores [Resistance](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md) and [Immunity](immunity-xphb.md).

Each time you use this feature again before finishing a [Long Rest](long-rest-xphb.md), the Necrotic damage per spell level increases by `1d12`.