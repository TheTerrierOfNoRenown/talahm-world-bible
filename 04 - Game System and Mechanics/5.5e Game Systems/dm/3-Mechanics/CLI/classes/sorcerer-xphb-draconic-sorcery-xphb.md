...
The magic in your body manifests physical traits of your draconic gift. Your [Hit Point](hit-points-xphb.md) maximum increases by 3, and it increases by 1 whenever you gain another Sorcerer level.
...
| 5th | [Fear](3-Mechanics/CLI/spells/fear-xphb.md), [Fly](fly-xphb.md) |
| 7th | [Arcane Eye](3-Mechanics/CLI/spells/arcane-eye-xphb.md), [Charm Monster](charm-monster-xphb.md) |
| 9th | [Legend Lore](legend-lore-xphb.md), [Summon Dragon](summon-dragon-xphb.md) |
^draconic-spells
...
You have [Resistance](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md) to that damage type, and when you cast a spell that deals damage of that type, you can add your Charisma modifier to one damage roll of that spell.
...
You can cast [Summon Dragon](summon-dragon-xphb.md) without a Material component. You can also cast it once without a spell slot, and you regain the ability to cast it in this way when you finish a [Long Rest](long-rest-xphb.md).
