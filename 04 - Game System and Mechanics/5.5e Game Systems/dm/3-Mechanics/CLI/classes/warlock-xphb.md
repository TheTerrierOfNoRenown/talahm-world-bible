...
**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](leather-armor-xphb.md), [Sickle](sickle-xphb.md), 2 [Daggers](dagger-xphb.md), [Arcane Focus](arcane-focus-xphb.md) ([orb](3-Mechanics/CLI/items/orb-xphb.md)), [Book](book-xphb.md) (occult lore), [Scholar's Pack](3-Mechanics/CLI/items/scholars-pack-xphb.md), and 15 GP; or (B) 100 GP
...
**Cantrips.** You know two Warlock cantrips of your choice. [Eldritch Blast](eldritch-blast-xphb.md) and [Prestidigitation](prestidigitation-xphb.md) are recommended. Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice.

When you reach Warlock levels 4 and 10, you learn another Warlock cantrip of your choice, as shown in the Cantrips column of the Warlock Features table.

**Spell Slots.** The Warlock Features table shows how many spell slots you have to cast your Warlock spells of levels 1–5. The table also shows the level of those slots, all of which are the same level. You regain all expended Pact Magic spell slots when you finish a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md).

For example, when you're a level 5 Warlock, you have two level 3 spell slots. To cast the level 1 spell [Witch Bolt](witch-bolt-xphb.md), you must spend one of those slots, and you cast it as a level 3 spell.

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Warlock spells. [Charm Person](charm-person-xphb.md) and [Hex](hex-xphb.md) are recommended.
...
**Spellcasting Focus.** You can use an [Arcane Focus](arcane-focus-xphb.md) as a [Spellcasting Focus](spellcasting-focus-xphb.md) for your Warlock spells.
...
- [Gift of the Depths](3-Mechanics/CLI/optional-features/gift-of-the-depths-xphb.md)  
...
- [Master of Myriad Forms](3-Mechanics/CLI/optional-features/master-of-myriad-forms-xphb.md)  
- [Misty Visions](3-Mechanics/CLI/optional-features/misty-visions-xphb.md)  
...
You can perform an esoteric rite for 1 minute. At the end of it, you regain expended Pact Magic spell slots but no more than a number equal to half your maximum (round up). Once you use this feature, you can't do so again until you finish a [Long Rest](long-rest-xphb.md).
...
You gain the [Ability Score Improvement](ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Warlock levels 8, 12, and 16.
...
Once you cast the spell with this feature, you can't do so in this way again until you finish a [Long Rest](long-rest-xphb.md).
...
You can cast your arcanum spell once without expending a spell slot, and you must finish a [Long Rest](long-rest-xphb.md) before you can cast it in this way again.

As shown in the Warlock Features table, you gain another Warlock spell of your choice that can be cast in this way when you reach Warlock levels 13 (level 7 spell), 15 (level 8 spell), and 17 (level 9 spell). You regain all uses of your Mystic Arcanum when you finish a [Long Rest](long-rest-xphb.md).
