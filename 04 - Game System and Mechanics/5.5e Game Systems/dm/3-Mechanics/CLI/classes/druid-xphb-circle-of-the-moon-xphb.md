...
|-------------|-----------------|
| 3 | [Cure Wounds](cure-wounds-xphb.md), [Moonbeam](moonbeam-xphb.md), [Starry Wisp](starry-wisp-xphb.md) |
...
**Challenge Rating.** The maximum [Challenge Rating](challenge-rating-xphb.md) for the form equals your Druid level divided by 3 (round down).
...
**Temporary Hit Points.** You gain a number of [Temporary Hit Points](temporary-hit-points-xphb.md) equal to three times your Druid level.
