...
![](3-Mechanics/CLI/backgrounds/img/artisan.webp)
...
- **Equipment.** Choose A or B: (A) [Artisan's Tools](artisans-tools-xphb.md) (same as above), 2 [Pouches](pouch-xphb.md), [Traveler's Clothes](3-Mechanics/CLI/items/travelers-clothes-xphb.md), 32 GP; or (B) 50 GP  
