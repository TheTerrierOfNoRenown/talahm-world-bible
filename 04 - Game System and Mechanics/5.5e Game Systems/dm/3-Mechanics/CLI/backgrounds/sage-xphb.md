...
- **Equipment.** Choose A or B: (A) [Quarterstaff](3-Mechanics/CLI/items/quarterstaff-xphb.md), [Calligrapher's Supplies](calligraphers-supplies-xphb.md), [Book](book-xphb.md) (history), [Parchment](3-Mechanics/CLI/items/parchment-xphb.md) (8 sheets), [Robe](3-Mechanics/CLI/items/robe-xphb.md), 8 GP; or (B) 50 GP  
