...
![](3-Mechanics/CLI/backgrounds/img/noble.webp)
...
- **Equipment.** Choose A or B: (A) [Gaming Set](gaming-set-xphb.md) (same as above), [Fine Clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), [Perfume](3-Mechanics/CLI/items/perfume-xphb.md), 29 GP; or (B) 50 GP  
