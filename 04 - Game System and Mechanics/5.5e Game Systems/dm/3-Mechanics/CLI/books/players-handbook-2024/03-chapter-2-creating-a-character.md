...
![World-traveling explorers Hank, Bobby, Sheila, Diana, and Presto stand on the threshold of their next adventure](3-Mechanics/CLI/books/players-handbook-2024/img/012-02-001-world-traveling-explorers.webp#center)
...
> 
> The classic D&D party comprises a [Cleric](3-Mechanics/CLI/classes/cleric-xphb.md), [Fighter](3-Mechanics/CLI/classes/fighter-xphb.md), [Rogue](3-Mechanics/CLI/classes/rogue-xphb.md), and [Wizard](wizard-xphb.md). Those four classes have the longest history in the game, but more importantly, they bring a balanced mix of capabilities to adventures. You're welcome to use that party setup or modify it using these guidelines:
> 
> - **Cleric.** Replace with [Bard](bard-xphb.md) or [Druid](druid-xphb.md)  
> - **Fighter.** Replace with [Barbarian](barbarian-xphb.md), [Monk](monk-xphb.md), [Paladin](paladin-xphb.md), or [Ranger](3-Mechanics/CLI/classes/ranger-xphb.md)  
> - **Rogue.** Replace with [Bard](bard-xphb.md) or [Ranger](3-Mechanics/CLI/classes/ranger-xphb.md)  
...
![Consider how your choices combine to set your character on the path to adventure](3-Mechanics/CLI/books/players-handbook-2024/img/013-02-002-character-choices.webp#center)
...
![Alignments might be visualized as a grid like this—along with creatures that embody those alignments](3-Mechanics/CLI/books/players-handbook-2024/img/020-02-009-alignments.webp#center)
...
The character sheet includes room to note your current Hit Points when you take damage, as well as any [Temporary Hit Points](temporary-hit-points-xphb.md) you might gain. There's also space to track [Death Saving Throws](death-saving-throw-xphb.md).
...
![Adventuring equipment improves as a character progresses through the tiers of play](3-Mechanics/CLI/books/players-handbook-2024/img/021-02-010-adventuring-equipment.webp#center)
...
In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [Fireball](3-Mechanics/CLI/spells/fireball-xphb.md), [Lightning Bolt](lightning-bolt-xphb.md), and [Raise Dead](raise-dead-xphb.md). Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.
...
![A character with Paladin and Warlock levels might call on both a mighty oath and an otherworldly patron](3-Mechanics/CLI/books/players-handbook-2024/img/022-02-011-paladin-warlock-multiclass.webp#center)
