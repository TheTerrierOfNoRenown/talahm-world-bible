...
When you take the [Attack](actions.md#Attack) action on your turn and attack with a Light weapon, you can make one extra attack as a Bonus Action later on the same turn. That extra attack must be made with a different Light weapon, and you don't add your ability modifier to the extra attack's damage unless that modifier is negative. For example, you can attack with a [Shortsword](3-Mechanics/CLI/items/shortsword-xphb.md) in one hand and a [Dagger](dagger-xphb.md) in the other using the [Attack](actions.md#Attack) action and a Bonus Action, but you don't add your Strength or Dexterity modifier to the damage roll of the Bonus Action unless that modifier is negative.
...
- **Craft.** [Acid](acid-xphb.md), [Alchemist's Fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md), [Component Pouch](component-pouch-xphb.md), [Oil](oil-xphb.md), [Paper](paper-xphb.md), [Perfume](3-Mechanics/CLI/items/perfume-xphb.md)  
...
- **Craft.** [Ink](ink-xphb.md), [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md)  
...
- **Craft.** [Club](club-xphb.md), [Greatclub](greatclub-xphb.md), [Quarterstaff](3-Mechanics/CLI/items/quarterstaff-xphb.md), [Barrel](3-Mechanics/CLI/items/barrel-xphb.md), [Chest](chest-xphb.md), [Ladder](ladder-xphb.md), [Pole](pole-xphb.md), [Portable Ram](portable-ram-xphb.md), [Torch](torch-xphb.md)  
...
- **Craft.** [Glass Bottle](glass-bottle-xphb.md), [Magnifying Glass](3-Mechanics/CLI/items/magnifying-glass-xphb.md), [Spyglass](spyglass-xphb.md), [Vial](vial-xphb.md)  
...
- **Craft.** [Sling](sling-xphb.md), [Whip](3-Mechanics/CLI/items/whip-xphb.md), [Hide Armor](hide-armor-xphb.md), [Leather Armor](leather-armor-xphb.md), [Studded Leather Armor](3-Mechanics/CLI/items/studded-leather-armor-xphb.md), [Backpack](backpack-xphb.md), [Crossbow Bolt Case](crossbow-bolt-case-xphb.md), [Map or Scroll Case](3-Mechanics/CLI/items/map-or-scroll-case-xphb.md), [Parchment](3-Mechanics/CLI/items/parchment-xphb.md), [Pouch](pouch-xphb.md), [Quiver](3-Mechanics/CLI/items/quiver-xphb.md), [Waterskin](waterskin-xphb.md)  
...
- **Craft.** [Jug](jug-xphb.md), [Lamp](3-Mechanics/CLI/items/lamp-xphb.md)  
...
- **Craft.** Any Melee weapon (except Club, Greatclub, Quarterstaff, and Whip), Medium armor (except Hide), Heavy armor, [Ball Bearings](3-Mechanics/CLI/items/ball-bearings-xphb.md), [Bucket](bucket-xphb.md), [Caltrops](3-Mechanics/CLI/items/caltrops-xphb.md), [Chain](chain-xphb.md), [Crowbar](3-Mechanics/CLI/items/crowbar-xphb.md), [Firearm Bullets](firearm-bullets-10-xphb.md), [Grappling Hook](3-Mechanics/CLI/items/grappling-hook-xphb.md), [Iron Pot](3-Mechanics/CLI/items/iron-pot-xphb.md), [Iron Spikes](3-Mechanics/CLI/items/iron-spikes-xphb.md), [Sling Bullets](sling-bullet-xphb.md)  
...
- **Craft.** [Musket](musket-xphb.md), [Pistol](pistol-xphb.md), [Bell](3-Mechanics/CLI/items/bell-xphb.md), [Bullseye Lantern](bullseye-lantern-xphb.md), [Flask](flask-xphb.md), [Hooded Lantern](3-Mechanics/CLI/items/hooded-lantern-xphb.md), [Hunter's Trap](hunting-trap-xphb.md), [Lock](lock-xphb.md), [Manacles](3-Mechanics/CLI/items/manacles-xphb.md), [Mirror](mirror-xphb.md), [Shovel](3-Mechanics/CLI/items/shovel-xphb.md), [Signal Whistle](signal-whistle-xphb.md), [Tinderbox](tinderbox-xphb.md)  
...
- **Craft.** [Padded Armor](padded-armor-xphb.md), [Basket](3-Mechanics/CLI/items/basket-xphb.md), [Bedroll](3-Mechanics/CLI/items/bedroll-xphb.md), [Blanket](blanket-xphb.md), [Fine Clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), [Net](3-Mechanics/CLI/items/net-xphb.md), [Robe](3-Mechanics/CLI/items/robe-xphb.md), [Rope](rope-xphb.md), [Sack](sack-xphb.md), [String](3-Mechanics/CLI/items/string-xphb.md), [Tent](3-Mechanics/CLI/items/tent-xphb.md), [Traveler's Clothes](3-Mechanics/CLI/items/travelers-clothes-xphb.md)  
...
- **Craft.** [Club](club-xphb.md), [Greatclub](greatclub-xphb.md), [Quarterstaff](3-Mechanics/CLI/items/quarterstaff-xphb.md), Ranged weapons (except Pistol, Musket, and Sling), [Arcane Focus](arcane-focus-xphb.md), [Arrows](arrows-20-xphb.md), [Bolts](3-Mechanics/CLI/items/bolts-20-xphb.md), [Druidic Focus](druidic-focus-xphb.md), [Ink Pen](3-Mechanics/CLI/items/ink-pen-xphb.md), [Needles](3-Mechanics/CLI/items/needles-50-xphb.md)  
...
- **Variants.** [Dice](3-Mechanics/CLI/items/dice-set-xphb.md) (1 SP), [dragonchess](dragonchess-set-xphb.md) (1 GP), [playing cards](playing-cards-xphb.md) (5 SP), [three-dragon ante](3-Mechanics/CLI/items/three-dragon-ante-set-xphb.md) (1 GP)  
...
- **Craft.** [Antitoxin](antitoxin-xphb.md), [Candle](3-Mechanics/CLI/items/candle-xphb.md), [Healer's Kit](healers-kit-xphb.md), [Potion of Healing](potion-of-healing-xdmg.md)  
...
An Arcane Focus takes one of the forms in the Arcane Focuses table and is bejeweled or carved to channel arcane magic. A Sorcerer, Warlock, or Wizard can use such an item as a [Spellcasting Focus](spellcasting-focus-xphb.md).
...
A Burglar's Pack contains the following items: [Backpack](backpack-xphb.md), [Ball Bearings](3-Mechanics/CLI/items/ball-bearings-xphb.md), [Bell](3-Mechanics/CLI/items/bell-xphb.md), 10 [Candles](3-Mechanics/CLI/items/candle-xphb.md), [Crowbar](3-Mechanics/CLI/items/crowbar-xphb.md), [Hooded Lantern](3-Mechanics/CLI/items/hooded-lantern-xphb.md), 7 flasks of [Oil](oil-xphb.md), 5 days of [Rations](rations-xphb.md), [Rope](rope-xphb.md), [Tinderbox](tinderbox-xphb.md), and [Waterskin](waterskin-xphb.md).
...
A Map or Scroll Case holds up to 10 sheets of [paper](paper-xphb.md) or 5 sheets of [parchment](3-Mechanics/CLI/items/parchment-xphb.md).
...
A Diplomat's Pack contains the following items: [Chest](chest-xphb.md), [Fine Clothes](3-Mechanics/CLI/items/fine-clothes-xphb.md), [Ink](ink-xphb.md), 5 [Ink Pens](3-Mechanics/CLI/items/ink-pen-xphb.md), [Lamp](3-Mechanics/CLI/items/lamp-xphb.md), 2 [Map or Scroll Cases](3-Mechanics/CLI/items/map-or-scroll-case-xphb.md), 4 flasks of [Oil](oil-xphb.md), 5 sheets of [Paper](paper-xphb.md), 5 sheets of [Parchment](3-Mechanics/CLI/items/parchment-xphb.md), [Perfume](3-Mechanics/CLI/items/perfume-xphb.md), and [Tinderbox](tinderbox-xphb.md).

### Druidic Focus (Varies)

A Druidic Focus takes one of the forms in the Druidic Focuses table and is carved, tied with ribbon, or painted to channel primal magic. A Druid or Ranger can use such an object as a [Spellcasting Focus](spellcasting-focus-xphb.md).

![Druidic Focus (Varies); Druidic Focuses](druidic-focus-varies-druidic-focuses-xphb.md)

### Dungeoneer's Pack (12 GP)

A Dungeoneer's Pack contains the following items: [Backpack](backpack-xphb.md), [Caltrops](3-Mechanics/CLI/items/caltrops-xphb.md), [Crowbar](3-Mechanics/CLI/items/crowbar-xphb.md), 2 flasks of [Oil](oil-xphb.md), 10 days of [Rations](rations-xphb.md), [Rope](rope-xphb.md), [Tinderbox](tinderbox-xphb.md), 10 [Torches](torch-xphb.md), and [Waterskin](waterskin-xphb.md).

### Entertainer's Pack (40 GP)

An Entertainer's Pack contains the following items: [Backpack](backpack-xphb.md), [Bedroll](3-Mechanics/CLI/items/bedroll-xphb.md), [Bell](3-Mechanics/CLI/items/bell-xphb.md), [Bullseye Lantern](bullseye-lantern-xphb.md), 3 [Costumes](3-Mechanics/CLI/items/costume-xphb.md), [Mirror](mirror-xphb.md), 8 flasks of [Oil](oil-xphb.md), 9 days of [Rations](rations-xphb.md), [Tinderbox](tinderbox-xphb.md), and [Waterskin](waterskin-xphb.md).

### Explorer's Pack (10 GP)

An Explorer's Pack contains the following items: [Backpack](backpack-xphb.md), [Bedroll](3-Mechanics/CLI/items/bedroll-xphb.md), 2 flasks of [Oil](oil-xphb.md), 10 days of [Rations](rations-xphb.md), [Rope](rope-xphb.md), [Tinderbox](tinderbox-xphb.md), 10 [Torches](torch-xphb.md), and [Waterskin](waterskin-xphb.md).
...
A Holy Symbol takes one of the forms in the Holy Symbol table and is bejeweled or painted to channel divine magic. A Cleric or Paladin can use a Holy Symbol as a [Spellcasting Focus](spellcasting-focus-xphb.md).
...
A Bullseye Lantern burns [Oil](oil-xphb.md) as fuel to cast [Bright Light](bright-light-xphb.md) in a 60-foot [Cone](cone-area-of-effect-xphb.md) and [Dim Light](dim-light-xphb.md) for an additional 60 feet.
...
A Lock comes with a key. Without the key, a creature can use [Thieves' Tools](3-Mechanics/CLI/items/thieves-tools-xphb.md) to pick this Lock with a successful DC 15 Dexterity ([Sleight of Hand](skills.md#Sleight%20of%20Hand)) check.
...
Each set of Manacles comes with a key. Without the key, a creature can use [Thieves' Tools](3-Mechanics/CLI/items/thieves-tools-xphb.md) to pick the Manacles' lock with a successful DC 15 Dexterity ([Sleight of Hand](skills.md#Sleight%20of%20Hand)) check.
...
Perfume comes in a 4-ounce vial. For 1 hour after applying Perfume to yourself, you have [Advantage](advantage-xphb.md) on Charisma ([Persuasion](skills.md#Persuasion)) checks made to influence an [Indifferent](indifferent-attitude-xphb.md) Humanoid within 5 feet of yourself.
...
A Pole is 10 feet long. You can use it to touch something up to 10 feet away. If you must make a Strength ([Athletics](skills.md#Athletics)) check as part of a [High](high-jump-xphb.md) or [Long Jump](long-jump-xphb.md), you can use the Pole to vault, giving yourself [Advantage](advantage-xphb.md) on the check.
...
A Priest's Pack contains the following items: [Backpack](backpack-xphb.md), [Blanket](blanket-xphb.md), [Holy Water](holy-water-xphb.md), [Lamp](3-Mechanics/CLI/items/lamp-xphb.md), 7 days of [Rations](rations-xphb.md), [Robe](3-Mechanics/CLI/items/robe-xphb.md), and [Tinderbox](tinderbox-xphb.md).
...
A Scholar's Pack contains the following items: [Backpack](backpack-xphb.md), [Book](book-xphb.md), [Ink](ink-xphb.md), [Ink Pen](3-Mechanics/CLI/items/ink-pen-xphb.md), [Lamp](3-Mechanics/CLI/items/lamp-xphb.md), 10 flasks of [Oil](oil-xphb.md), 10 sheets of [Parchment](3-Mechanics/CLI/items/parchment-xphb.md), and [Tinderbox](tinderbox-xphb.md).
...
A Tinderbox is a small container holding flint, fire steel, and tinder (usually dry cloth soaked in light oil) used to kindle a fire. Using it to light a [Candle](3-Mechanics/CLI/items/candle-xphb.md), [Lamp](3-Mechanics/CLI/items/lamp-xphb.md), Lantern, or [Torch](torch-xphb.md)—or anything else with exposed fuel—takes a Bonus Action. Lighting any other fire takes 1 minute.
...
Using the rules below, characters can make nonmagical items, [Potions of Healing](potion-of-healing-xdmg.md), and [Spell Scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md).
