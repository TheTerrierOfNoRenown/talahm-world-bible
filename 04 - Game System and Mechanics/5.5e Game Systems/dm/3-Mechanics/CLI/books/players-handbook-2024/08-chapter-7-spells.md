...
![Archmages of Greyhawk—Jallarzi, Mordenkainen, and Bigby—prepare their magic as they open a gate to another plane](3-Mechanics/CLI/books/players-handbook-2024/img/181-08-001-jallarzi-mordenkainen-bigby.webp#center)
...
When a spellcaster casts a spell using a slot that is of a higher level than the spell, the spell takes on the higher level for that casting. For instance, if a Wizard casts [Magic Missile](magic-missile-xphb.md) using a level 2 slot, that *Magic Missile* is level 2. Effectively, the spell expands to fill the slot it is put into.

Some spells, such as [Magic Missile](magic-missile-xphb.md) and [Cure Wounds](cure-wounds-xphb.md), have more powerful effects when cast at a higher level, as detailed in a spell's description.
...
![An aasimar Wizard uses a crystal material component to focus the magic of Cone of Cold](3-Mechanics/CLI/books/players-handbook-2024/img/182-08-002-aasimar-wizard.webp#center)
...
If a spell doesn't consume its materials and doesn't specify a cost for them, a spellcaster can use a [Component Pouch](component-pouch-xphb.md) (see "chapter 6") instead of providing the materials specified in the spell, or the spellcaster can substitute a [Spellcasting Focus](spellcasting-focus-xphb.md) if the caster has a feature that allows that substitution. To use a Component Pouch, you must have a hand free to reach into it, and to use a [Spellcasting Focus](spellcasting-focus-xphb.md), you must hold it unless its description says otherwise (see "chapter 6" for descriptions).
...
To target something with a spell, a caster must have a clear path to it, so it can't be behind [Total Cover](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/rules/variant-rules/cover-xphb.md).

##### Targeting Yourself

If a spell targets a creature of your choice, you can choose yourself unless the creature must be [Hostile](hostile-attitude-xphb.md) or specifically a creature other than you.

##### Areas of Effect

Some spells, such as [Thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md), cover an area called an [area of effect](area-of-effect-xphb.md), which is defined in the "rules glossary". The area determines what the spell targets. The description of a spell specifies whether it has an area of effect, which is typically one of these shapes: [Cone](cone-area-of-effect-xphb.md), [Cube](cube-area-of-effect-xphb.md), [Cylinder](cylinder-area-of-effect-xphb.md), [Emanation](emanation-area-of-effect-xphb.md), [Line](line-area-of-effect-xphb.md), or [Sphere](sphere-area-of-effect-xphb.md).
...
- [Befuddlement](3-Mechanics/CLI/spells/befuddlement-xphb.md)  
...
- [Darkness](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/spells/darkness-xphb.md)  
...
- [Giant Insect](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/spells/giant-insect-xphb.md)  
...
- [Ice Knife](3-Mechanics/CLI/spells/ice-knife-xphb.md)  
...
- [Jallarzi's Storm of Radiance](3-Mechanics/CLI/spells/jallarzis-storm-of-radiance-xphb.md)  
- [Jump](jump-xphb.md)  
...
- [Resistance](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/spells/resistance-xphb.md)  
...
- [Steel Wind Strike](3-Mechanics/CLI/spells/steel-wind-strike-xphb.md)  
...
- [Summon Aberration](3-Mechanics/CLI/spells/summon-aberration-xphb.md)  
- [Summon Beast](3-Mechanics/CLI/spells/summon-beast-xphb.md)  
- [Summon Celestial](summon-celestial-xphb.md)  
- [Summon Construct](summon-construct-xphb.md)  
- [Summon Dragon](summon-dragon-xphb.md)  
- [Summon Elemental](3-Mechanics/CLI/spells/summon-elemental-xphb.md)  
...
- [Synaptic Static](3-Mechanics/CLI/spells/synaptic-static-xphb.md)  

- [Tasha's Bubbling Cauldron](3-Mechanics/CLI/spells/tashas-bubbling-cauldron-xphb.md)  
- [Tasha's Hideous Laughter](3-Mechanics/CLI/spells/tashas-hideous-laughter-xphb.md)  
- [Telekinesis](telekinesis-xphb.md)  
- [Telepathy](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/spells/telepathy-xphb.md)  
