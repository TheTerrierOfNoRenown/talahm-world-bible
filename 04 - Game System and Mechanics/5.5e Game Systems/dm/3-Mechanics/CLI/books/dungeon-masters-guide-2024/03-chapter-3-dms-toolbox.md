...
![A Blob of Annihilation attacks Sharn, the City of Towers, in the world of Eberron](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/021-02-001-blob-attack.webp#center)
...
A creature's alignment can help you determine the creature's attitude in an encounter. A Chaotic Evil monster is likely to be [Hostile](hostile-attitude-xphb.md), while a Lawful Good one is more likely to have a [Friendly](friendly-attitude-xphb.md) attitude, ready to help those in need.
...
![An exciting chase nears its conclusion](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/022-02-002-party-gives-chase.webp#center)
...
Know the capabilities of the characters in your party before you make a chase an important feature of an adventure. A character with a high Speed or the right spell (such as [Dimension Door](dimension-door-xphb.md), [Fly](fly-xphb.md), or [Hold Monster](3-Mechanics/CLI/spells/hold-monster-xphb.md)) can often end a chase before it begins.
...
A chase participant can take the [Dash](actions.md#Dash) action a number of times equal to 3 plus its Constitution modifier (minimum of once). Each additional Dash action it takes during the chase requires the creature to succeed on a DC 10 Constitution saving throw at the end of its turn or gain 1 [Exhaustion](conditions.md#Exhaustion) level. A participant drops out of the chase if it has 5 [Exhaustion](conditions.md#Exhaustion) levels. A creature can remove the [Exhaustion](conditions.md#Exhaustion) levels it gained during the chase by finishing a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md).

#### Spells and Attacks

A chase participant can make attacks and cast spells against other creatures within range.

Chase participants can't normally make [Opportunity Attacks](actions.md#Opportunity%20Attack) against each other, since they are all assumed to be moving in the same direction at the same time. However, participants can still be the targets of [Opportunity Attacks](actions.md#Opportunity%20Attack) from creatures not participating in the chase. For example, adventurers who chase a thief past a gang of ruffians might provoke [Opportunity Attacks](actions.md#Opportunity%20Attack) from the ruffians.
...
Other factors might help or hinder the quarry's ability to escape, at your discretion. For example, a quarry with a [Faerie Fire](faerie-fire-xphb.md) spell cast on it might have Disadvantage on checks made to escape because it's much easier to spot.
...
![An ill-advised attempt to steal Xanathar's pet goldfish, Sylgar, leads to a heated chase](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/023-02-003-sylgar-theft.webp#center)
...
![You might alter the Sailor background to reflect a character's youth on the seas of Greyhawk](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/024-02-004-seas-of-greyhawk.webp#center)
...
![Baba Yaga invents a new creature—a fire-breathing Giant Toad!](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/025-02-005-baba-yaga.webp#center)
...
You can change any or all of the languages the creature knows. You might want to add languages if you've made a creature sapient that wasn't before. You can also add or remove [telepathy](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/rules/variant-rules/telepathy-xphb.md) or other forms of communication.
...
You can freely change the name and flavor of an attack, as well as its damage type. For example, you can turn an ordinary [Skeleton](skeleton-xmm.md) into an ice skeleton that deals Cold damage as it accosts characters with a blade of ice or hurls shards of ice at them.

#### Resistances and Immunities

If a creature doesn't have [Resistance](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/rules/variant-rules/resistance-xphb.md) or [Immunity](immunity-xphb.md) to one or more damage types, you can give it Resistance or Immunity to one or two damage types. You can also change the damage type of its existing Resistances and Immunities.
...
- **Dimensional Disruption.** Disruptive energy extends from the creature in a 30-foot [Emanation](emanation-area-of-effect-xphb.md). Other creatures can't teleport to or from a space in that area. Any attempt to do so is wasted.  
- **Disciple of the Nine Hells.** When the creature dies, its body disgorges a [Hostile](hostile-attitude-xphb.md) [Imp](imp-xmm.md) in the same space.  
...
- **Emissary of Juiblex.** When the creature dies, its body disgorges a [Hostile](hostile-attitude-xphb.md) [Ochre Jelly](ochre-jelly-xmm.md) in the same space.  
...
- **Gloom Shroud.** Imperceptible energy channeled from the "Shadowfell" extends from the creature in a 20-foot [Emanation](emanation-area-of-effect-xphb.md). Other creatures in that area have [Disadvantage](disadvantage-xphb.md) on Charisma checks and Charisma saving throws.  
...
- **Slaad Host.** When the creature dies, a [Hostile](hostile-attitude-xphb.md) [Slaad Tadpole](slaad-tadpole-xmm.md) bursts from its innards in the same space.  
...
![Ringlerun's spell research leads in unexpected directions as he unintentionally creates a flying gelatinous cubelet](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/026-02-006-ringlerun-researching.webp#center)
...
![The curse of demonic possession has devastating effects](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/027-02-007-demonic-possession.webp#center)

Every curse has rules that govern it. A curse typically takes one of the forms detailed below.

#### Bestow Curse

The simplest curses are created by the [Bestow Curse](bestow-curse-xphb.md) spell. The effects of such curses are limited and can be ended by the [Remove Curse](remove-curse-xphb.md) spell.
...
You decide how a spell like [Remove Curse](remove-curse-xphb.md) affects a creature with accursed origins. For example, you might decide that a mummy was created through a curse and it can be destroyed permanently only by casting *Remove Curse* on its corpse.
...
A creature affected by such a curse should know why they're being punished and be able to learn how to end their curse, likely by symbolically righting the wrong they committed. How a spell like [Remove Curse](remove-curse-xphb.md) affects a curse that's part of your adventure is up to you—the spell might merely suppress the effects of the curse for a time. Regardless, narrative curses should feel like rare, potent magic rooted in the lore of your campaign.
...
After finishing a Long Rest, a creature with Demonic Possession makes a DC 15 Charisma saving throw. On a successful save, the effect ends on the creature. A [Dispel Evil and Good](3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md) spell or any magic that removes a curse also ends the effect on it.
...
![Sometimes death—even the death of an entire party—is just a passage to new adventures](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/028-02-008-death-passage.webp#center)
...
When a character is reduced to 0 Hit Points, the player sometimes has to sit out one or more rounds of combat with nothing to do but roll [Death Saving Throws](death-saving-throw-xphb.md). One way to keep a player involved in the game is to prompt some roleplaying along with each Death Save. You might ask the player to describe a memory that surfaces in the character's mind while hovering near death. Consider these possibilities:
...
A powerful individual finds the adventurers' bodies and has them raised from the dead, putting the adventurers in the debt of their rescuer. What if the adventurers wake up decades after their death, returned to life by a [Resurrection](3-Mechanics/CLI/spells/resurrection-xphb.md) spell cast by someone who believed they had an important role to play in this future era?
...
![A dungeon built by giants offers enormous adventures](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/029-02-009-giants-dungeon.webp#center)
...
![A friendly bronze dragon keeps a watchful eye on a storm-tossed ship](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/030-02-010-bronze-dragon-v-ship.webp#center)
...
- [Dead Magic Zone](3-Mechanics/CLI/traps-hazards/dead-magic-zone-xdmg.md)  
...
- [Planar Effects](3-Mechanics/CLI/traps-hazards/planar-effects-xdmg.md)  
...
The character has the [Frightened](conditions.md#Frightened), [Incapacitated](conditions.md#Incapacitated), or [Stunned](conditions.md#Stunned) condition for `1d10` minutes. This condition might be accompanied by alarming behavior or hallucinations. These effects can be suppressed with the [Calm Emotions](3-Mechanics/CLI/spells/calm-emotions-xphb.md) spell or removed by the [Lesser Restoration](3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spell.
...
![Fight, flight, or freeze?](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/031-02-011-fight-flight-or-freeze.webp#center)
...
![When faced with a troll, there's no time to figure out the right way to hold a shotgun](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/032-02-012-troll-v-firearms.webp#center)
...
![Firearms](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/tables/firearms-xdmg.md)
...
As an action, you can either throw a grenade at a point up to 60 feet away or use a Grenade Launcher to propel the grenade to a point up to 1,000 feet away. The grenade explodes at that point, creating a particular effect in a 20-foot-radius [Sphere](sphere-area-of-effect-xphb.md).

#### Fragmentation Grenade

Each creature in the [Sphere](sphere-area-of-effect-xphb.md) makes a DC 15 Dexterity saving throw, taking 17 (`5d6`) Piercing damage on a failed save or half as much damage on a successful one.

#### Smoke Grenade

The area of the [Sphere](sphere-area-of-effect-xphb.md) is [Heavily Obscured](heavily-obscured-xphb.md) by smoke for 1 minute. A strong wind (such as the [Gust of Wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md) spell) disperses the smoke.

#### Gunpowder

Setting fire to a container full of Gunpowder causes it to explode. When a container explodes, each creature in a 10-foot-radius [Sphere](sphere-area-of-effect-xphb.md) centered on the container makes a DC 12 Dexterity saving throw, taking 10 (`3d6`) Fire damage (for a powder horn) or 24 (`7d6`) Fire damage (for a keg) on a failed save or half as much damage on a successful one.
...
The "Player's Handbook" describes common hazards that adventurers encounter, such as [falling](falling-xphb.md) and [dehydration](dehydration-xphb.md). This section details some more unusual hazards you can add to a location to make it more challenging.
...
- [Green Slime](3-Mechanics/CLI/traps-hazards/green-slime-xdmg.md)  
...
![](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/035-02-015-spiders.webp#center)
...
![Queen Yolande of Celene is grateful for adventurers' aid](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/036-02-016-queen-yolande.webp#center)
...
Whenever you would otherwise make a number of [D20 Tests](d20-test-xphb.md) for identical monsters, the Mob Results table can help you determine the number of successful [D20 Tests](d20-test-xphb.md) the monsters get without having to roll dice. Follow these steps:

- **Step 1.** Determine the minimum `d20` roll the monsters need to succeed on the [D20 Test](d20-test-xphb.md) using the following formula:  
...
- **Step 3.** Read across the table to find a fractional number of successes you can easily apply to the group of monsters. That's the fraction of monsters that succeed on the [D20 Test](d20-test-xphb.md).  

![Average Results; Mob Results](average-results-mob-results-xdmg.md)

### Adjudicating Areas of Effect

When the characters are fighting a large number of monsters, it's not always practical to use miniatures on a battle grid or some other visual aid. So how do you determine how many monsters are affected by the Wizard's [Fireball](3-Mechanics/CLI/spells/fireball-xphb.md) spell or some other area of effect?
...
Your judgment always outweighs these guidelines, and it's fine to err on the side of affecting more creatures. For example, if eight zombies are crowded around a Fighter when the Bard centers a [Shatter](shatter-xphb.md) spell on the Fighter's space, the spell's area should definitely engulf all eight zombies, even though according to the table, a 10-foot-radius [Sphere](sphere-area-of-effect-xphb.md) includes only three creatures.
...
![Nonplayer Characters come in all shapes and sizes](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/037-02-017-nonplayer-characters.webp#center)
...
![](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/038-02-018-lone-npc.webp#center)
...
For example, if you find the adventurers unexpectedly arguing with a Lawful Neutral guard, you might create a cooperative but laconic guard who is happy to help the adventurers but speaks curtly, hoping to end the conversation as quickly as possible. Or, looking at the [Imp](imp-xmm.md) stat block in the "Player's Handbook" and noting its highest ability (Dexterity) and its lowest (Strength), you might decide that the little devil is fidgety and indirect, constantly on the move and talking in circles to get to its point
...
![Download PDF](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/039-02-019-npc-tracker-sheet.webp#center)
...
You can use different stat blocks in the "Monster Manual", perhaps with some tweaks, to reflect the same NPC at different times as they grow over the course of a campaign. For example, characters on their very first adventure might face a villain who uses the stat block of a [Mage Apprentice](3-Mechanics/CLI/bestiary/humanoid/mage-apprentice-xmm.md), only to have that villain escape and return many adventures later to haunt them as a [Mage](mage-xmm.md). Still later, the same villain might reappear as an [Archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md). Of course, the trick here is making sure that the villain survives from one adventure to the next, or at least coming up with a plausible way for the villain to return from death. After all, death is rarely the final word for adventurers, so it needn't be for their opponents.
...
- **Milquetoast Healer.** Absent a healer of their own, the characters might love an NPC healer whose personality matters less than the healer's devotion to the party and ability to cast [Cure Wounds](cure-wounds-xphb.md) or [Revivify](3-Mechanics/CLI/spells/revivify-xphb.md) when needed.  
...
![As a member of another group of heroes, Niko first joined Sheila, Diana, Eric, and Presto as an NPC healer](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/040-02-020-npc-healer.webp#center)
...
![Life in a city is full of fantastical surprises!](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/042-02-022-city-life.webp#center)
...
![](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/043-02-023-flagon-with-coins.webp#center)

![Download PDF](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/044-02-024-settlement-tracker-sheet.webp#center)
...
![A magical creature like a unicorn might bestow a supernatural gift](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/047-02-027-unicorn.webp#center)
...
Some Charms can be used only once; others can be used a specific number of times before vanishing. If a Charm lets a character cast a spell, the character can do so without expending a spell slot or providing any spell components. Unless otherwise stated, the spell uses its normal casting time, range, and duration; if the spell requires [Concentration](conditions.md#Concentration), the character must concentrate.

A Charm can't be removed from a creature by anything short of divine intervention or a [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell. A character can't benefit from multiple instances of a Charm at the same time.
...
- [Falling Net](3-Mechanics/CLI/traps-hazards/falling-net-xdmg.md)  
- [Fire-Casting Statue](3-Mechanics/CLI/traps-hazards/fire-casting-statue-xdmg.md)  
...
- [Spiked Pit](3-Mechanics/CLI/traps-hazards/spiked-pit-xdmg.md)  
