...
![The fiendish villain Venger uses a Crystal Ball to scry on his nemesis, Tiamat](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/006-01-001-scrying-venger.webp#center)
...
![Different players enjoy different aspects of playing D&D](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/007-01-002-traveling-party.webp#center)
...
![Adventures requiring stealth, like this infiltration, are ideal for some small parties of adventurers](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/008-01-003-party-infiltration.webp#center)
...
![](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/009-01-004-metal-cup.webp#center)
...
![A dungeon room offers plenty of details for adventurers to explore](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/010-01-005-old-office.webp#center)
...
- **Is a D20 Test Warranted?.** If the task is trivial or impossible, don't bother with a [D20 Test](d20-test-xphb.md). A character can move across an empty room or drink from a flask without making a Dexterity check, whereas no lucky die roll will allow a character with an ordinary bow to hit the moon with an arrow. Call for a [D20 Test](d20-test-xphb.md) only if there's a chance of both success and failure and if there are meaningful consequences for failure.  
...
The sections that follow offer advice on how to use each kind of [D20 Test](d20-test-xphb.md), when to apply [Advantage](advantage-xphb.md) and [Disadvantage](disadvantage-xphb.md), and how to decide what the consequences of success or failure might be.
...
When a character fails a [D20 Test](d20-test-xphb.md) by only 1 or 2, you can offer to let the character succeed at the cost of a complication or hindrance. Such complications can run along any of the following lines:

- A character gets her sword past an enemy's defenses and turns a near miss into a hit, but she then drops the sword.  
- A character narrowly escapes the full brunt of a [Fireball](3-Mechanics/CLI/spells/fireball-xphb.md) spell but has the [Prone](conditions.md#Prone) condition.  
...
![When a flying fortress crashes to the ground, unfortunate adventurers in its path might take `18d10` damage or more!](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/011-01-006-falling-fortress.webp#center)
...
- **Dexterity.** An NPC is [Hostile](hostile-attitude-xphb.md) toward intruders, so the characters must talk from hiding. Or the social interaction provides a distraction that allows a character to get close enough to the NPC to steal something from the NPC's pockets.  
...
Each creature controlled by the DM has one of the following attitudes toward the adventurers: [Friendly](friendly-attitude-xphb.md), [Indifferent](indifferent-attitude-xphb.md), or [Hostile](hostile-attitude-xphb.md). The ""Monster Behavior"" section in "chapter 4" offers guidance to help you determine a creature's initial attitude.
...
![Exploration draws adventurers into all sorts of unusual environments](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/012-01-007-exploring-party.webp#center)
...
![In a courtyard full of monsters, will characters even notice that the tree has eyes?](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/013-01-008-monster-courtyard.webp#center)
...
![Download PDF](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/014-01-009-travel-planner-sheet.webp#center)
...
If a party can travel at a high Speed for an extended time, as with a spell such as [Wind Walk](wind-walk-xphb.md) or a magic item such as a [Carpet of Flying](3-Mechanics/CLI/items/carpet-of-flying-xdmg.md), translate the party's Speed into travel rates using these rules:
...
![Traveling through fantastical landscapes can be a fun and interesting part of any adventure](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/015-01-010-fantastical-landscapes.webp#center)
...
- **Resting.** The trackers resume tracking after finishing a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md).  
...
![A river presents an obstacle to characters traveling through the wilderness](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/016-01-011-river-party.webp#center)
...
![Three ogres block a narrow mountain pass](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/017-01-012-three-ogres.webp#center)
...
![Creature Size on Squares and Hexes](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/018-01-013-creature-size-square-and-hex.webp#center)

![Cover on Squares and Hexes](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/019-01-014-cover-on-squares-hexes.webp#center)
...
The accompanying diagrams illustrate cover on squares or hexes. To determine whether a target has cover against an attack or other effect, choose a corner of the attacker's space or the point of origin of an area of effect. Then trace imaginary lines from that corner to every corner of any one square the target occupies. If one or two of those lines are blocked by an obstacle (including a creature), the target has [Half Cover](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/tables/cover-xphb.md). If three or four of those lines are blocked but the attack or effect can still reach the target (such as when the target is behind an arrow slit), the target has [Three-Quarters Cover](04%20-%20Game%20System%20and%20Mechanics/5.5e%20Game%20Systems/dm/3-Mechanics/CLI/tables/cover-xphb.md).
...
> 
> You can also use [Heroic Inspiration](heroic-inspiration-xphb.md) to reward roleplaying, immersion in the game, and heroism. Use it to incentivize the kind of behavior you want to see in your game, such as acting in character, taking risks, thinking strategically, cooperating well, or embracing the tropes of a particular genre. Make sure your use of [Heroic Inspiration](heroic-inspiration-xphb.md) is aligned with the expectations you set out at the start of your game (see ""Ensuring Fun for All"" in "chapter 1").
^awarding-heroic-inspiration

![A dragon's arrival makes a simple fight against zombies much more interesting](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/020-01-016-dragon-arrives.webp#center)
...
Share information with the players about the characteristics of creatures they fight as those characteristics become apparent. For example, if a Wizard casts [Fire Bolt](3-Mechanics/CLI/spells/fire-bolt-xphb.md) against a [Fire Elemental](3-Mechanics/CLI/bestiary/elemental/fire-elemental-xmm.md) (a creature that has Immunity to Fire damage), let the players know the spell doesn't seem to bother the creature at all. Players might correctly guess that a creature made of fire probably be wouldn't harmed by *Fire Bolt*; feel free to confirm their guesses.
...
It's important that players can tell when their characters' opponents are casting spells, giving the characters the opportunity to cast [Counterspell](3-Mechanics/CLI/spells/counterspell-xphb.md) or otherwise interfere with the spellcasting.
...
You can transform one monster into another to keep a fight interesting. Maybe a [worg](worg-xmm.md) splits open, and a [gibbering mouther](3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md) spills out to take its place. Or a cultist is consumed in a pillar of infernal flame, and a devil erupts from the ashes. You can also alter a monster's stat block in subtle ways in the middle of combat; for example, you might decide that a monster flies into a frenzy when it's [Bloodied](conditions.md#Bloodied), giving it [Advantage](advantage-xphb.md) on its attack rolls—and giving the characters Advantage on their attack rolls against it as well, speeding the fight to an end.
...
- The monster starts its turn [Bloodied](conditions.md#Bloodied) and has the [Frightened](conditions.md#Frightened) condition.  
