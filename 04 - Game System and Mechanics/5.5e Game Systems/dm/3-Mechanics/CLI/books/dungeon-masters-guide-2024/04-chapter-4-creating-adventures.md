...
![A mysterious carriage brings the vampire Strahd von Zarovich out from Castle Ravenloft](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/049-03-001-mysterious-carraige.webp#center)
...
![The death of an ancient dragon can shake the foundations of the world](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/050-03-002-death-of-a-dragon.webp#center)
...
![When rival factions inhabit a ruined dungeon, sometimes the best course is to stay out of the way!](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/052-03-004-rival-factions.webp#center)
...
![Otto's conversation with a magic mirror is an exciting social interaction encounter](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/054-03-006-magic-mirror.webp#center)
...
- 1 [Bugbear Warrior](bugbear-warrior-xmm.md) (200 XP)  
...
- 1 [Wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) (700 XP), 1 [Warhorse Skeleton](3-Mechanics/CLI/bestiary/undead/warhorse-skeleton-xmm.md) (100 XP), and 6 [Skeletons](skeleton-xmm.md) (50 XP each), for 1,100 XP total  
...
![Kobolds build a barricade to keep adventurers at bay](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/056-03-008-kobold-hold.webp#center)

#### Initial Attitudes

A published adventure typically notes or implies whether a creature's initial attitude toward the adventurers is [Friendly](friendly-attitude-xphb.md), [Indifferent](indifferent-attitude-xphb.md), or [Hostile](hostile-attitude-xphb.md). In an encounter you've created, you can decide that starting attitude, or you can randomly determine it using the Initial Attitude table.
...
![Mysterious lights glimmer in a remote mountain lake, drawing adventurers to explore](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/057-03-009-glimmering-lake.webp#center)
...
![A climactic battle at the Temple of Elemental Evil brings an adventure to a dramatic end](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/058-03-010-temple-of-elemental-evil.webp#center)
...
- **Berserk Bear.** In a side cave to the southeast is a [Brown Bear](brown-bear-xmm.md) that drank from the stream. It's upset because the water made it ill. If the characters can make it eat Borogrove's acorn or otherwise rid it the [Poisoned](conditions.md#Poisoned) condition, the bear recovers immediately and leaves them alone.  
- **Ooze's Lair.** At the north end of the stream are a [Psychic Gray Ooze](3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md) and six [Stirges](stirge-xmm.md). After defeating these creatures, the characters can destroy the brain-like fungus in the water, which is the source of the corruption. If they do, each character earns a bonus 100 XP.  
...
- Two [Spell Scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) ([Alarm](alarm-xphb.md) and [Comprehend Languages](comprehend-languages-xphb.md))  
...
Melchis hires a ship to carry the party to the Amedio Jungle. Use the map to determine how long the sea voyage takes, depending on where the adventurers begin the trip and figuring that the ship covers about 1½ hexes per day. Near the end of the trip, as the ship crosses Jeklea Bay, it's attacked by a group of [Hostile](hostile-attitude-xphb.md) sahuagin, including two [Sahuagin Priests](sahuagin-priest-xmm.md), six [Sahuagin Warriors](sahuagin-warrior-xmm.md), and a [Water Elemental](water-elemental-xmm.md). (Assume the ship's crew stays out of the way of these terrifying monsters and lets the characters and Melchis deal with this threat.) Stage 1 ends when Melchis and the characters row a launch ashore.
...
The Horns of the Beast—a jagged crown made from the horns of demons and wild animals—rests on a pedestal in the northwest corner of the ruins. Melchis immediately attempts to seize the Artifact and place it on his head. If he does, he is transformed into a [Hezrou](hezrou-xmm.md) and tries to kill the characters. A character who dons the Artifact is cursed with "Demonic Possession" (see ""Curses and Magical Contagions"" in "chapter 3"). The Artifact can't be removed from the character's head until a [Remove Curse](remove-curse-xphb.md) spell is cast on the character. If the characters defeat Melchis and search him, they find a [Bag of Holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md) containing twelve 5-pound gold trade bars (worth 250 GP each) and a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Teleportation Circle](teleportation-circle-xphb.md). The scroll also contains the sigil sequence for a permanent teleportation circle. At the end of the adventure, each character earns a bonus 1,000 XP.
...
![Minsc, Boo, and Delina navigate the intrigues of the Boreal Ball](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/059-03-011-boreal-ball.webp#center)
...
- Cannifer is a [Satyr Revelmaster](satyr-revelmaster-xmm.md) who is used to being the center of attention at every ball he attends and is thus [Hostile](hostile-attitude-xphb.md) to the adventurers.  
- Darisis a [Friendly](friendly-attitude-xphb.md), fun-loving [Dryad](dryad-xmm.md) who wants to be seen dancing with all the adventurers.  
- Fidget is a playful [Pixie](3-Mechanics/CLI/bestiary/fey/pixie-xmm.md) who is [Indifferent](indifferent-attitude-xphb.md) and pesters the adventurers with pranks throughout the evening, without causing any actual harm.  
- Granny Snailtongue is a [Hostile](hostile-attitude-xphb.md) [Green Hag](green-hag-xmm.md) who sees the adventurers as potentially useful tools. She offers to help them at every turn in hopes of putting them in her debt.  
- Raxas Albrethin is an arrogant, Chaotic Neutral drow [Mage](mage-xmm.md) who is initially [Hostile](hostile-attitude-xphb.md) and wants to see the adventurers humiliated. However, once the characters' Renown Score reaches 6, Raxas admits he misjudged them and becomes [Friendly](friendly-attitude-xphb.md).  
