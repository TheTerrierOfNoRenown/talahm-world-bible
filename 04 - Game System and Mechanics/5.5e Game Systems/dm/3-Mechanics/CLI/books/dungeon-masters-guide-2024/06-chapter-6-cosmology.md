...
![The Lady of Pain appears without warning in the bustling streets of Sigil, and the city's residents get out of her way](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/084-06-001-the-lady-of-pain.webp#center)
...
![](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/085-06-002-the-multiverse.webp#center)
...
A number of spells allow direct or indirect access to different planes of existence. [Gate](gate-xphb.md) and [Plane Shift](plane-shift-xphb.md) can directly transport adventurers to any other plane, with different degrees of precision. [Etherealness](etherealness-xphb.md) allows adventurers to enter the Ethereal Plane. And [Astral Projection](3-Mechanics/CLI/spells/astral-projection-xphb.md) lets adventurers project themselves into the Astral Plane and from there travel to the Outer Planes.
...
![A portal to the Beastlands opens amid the branches of the World Tree](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/086-06-003-portal-to-the-beastlands.webp#center)
...
![The detritus of the Planes is tangled in the Demonweb Pits](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/087-06-004-demonweb-pits.webp#center)
...
![A spelljamming wasp ship approaches the githyanki city of Tu'Narath](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/089-06-006-tunarath.webp#center)
...
![Unknown horrors are entrapped in the ice of Carceri](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/090-06-007-ice-of-carceri.webp#center)
...
![Aarakocra scouts return home to a city on the Plane of Air](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/091-06-008-plane-of-air.webp#center)
...
![The City of Brass is a hub for trade from across the multiverse](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/092-06-009-city-of-brass.webp#center)
...
To reach the Deep Ethereal, one typically needs a [Plane Shift](plane-shift-xphb.md) spell, a [Gate](gate-xphb.md) spell, or a magical portal. Visitors to the Deep Ethereal are engulfed by roiling mist. Scattered throughout the plane are curtains of vaporous color, and passing through a curtain leads a traveler to a region of the Border Ethereal connected to a specific Inner Plane, the Material Plane, the Feywild, or the Shadowfell. The color of the curtain indicates the plane whose Border Ethereal the curtain conceals; see the Ethereal Curtains table. The curtains are also distinguishable by texture and temperature, each one reflecting something of the nature of the plane beyond.

![The Radiant Citadel is a refuge in the Ethereal Plane, despite its proximity to a raging ether cyclone](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/093-06-010-the-radiant-citadel.webp#center)
...
![When the Dragon's Tear comet appears above Firestorm Peak, the Vast Gate forms a bridge to the Far Realm](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/095-06-012-the-vast-gate.webp#center)
...
Whenever a creature or group of creatures leaves the Feywild after spending at least 1 day on that plane, you can choose a time change that works best for your campaign, if any, or roll on the Feywild Time Warp table. A [Wish](3-Mechanics/CLI/spells/wish-xphb.md) spell can be used to remove the effect on up to ten creatures. Some powerful Fey have the ability to grant such wishes and might do so if the beneficiaries agree to subject themselves to a [Geas](geas-xphb.md) spell and complete a quest after the *Wish* spell is cast.
...
![Fey revel in the Gloaming Court under the watchful eye of the Queen of Air and Darkness](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/096-06-013-the-gloaming-court.webp#center)
...
![With its magical marvels of technology, Eberron is one of countless worlds on the Material Plane](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/097-06-014-eberron-technology.webp#center)
...
![The Seven Heavens of Mount Celestia beckon virtuous souls toward ever-greater heights](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/098-06-015-mount-celestia.webp#center)
...
![The first of Nine Hells, Avernus, is an eternal battlefield in the Blood War](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/099-06-016-avernus.webp#center)
...
![Asmodeus, the Lord of the Nine, maintains a veneer of pleasantry while inflicting agony on imprisoned souls](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/100-06-017-asmodeus.webp#center)
...
![Three adventurers brave the howling winds of Pandemonium in search of Howler's Crag](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/101-06-018-winds-of-pandemonium.webp#center)
...
![The Shadowfell is a realm of death, despair, and dread](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/102-06-019-the-shadowfell.webp#center)
...
![In the cosmopolitan streets of Sigil, creatures from across the multiverse coexist in uneasy peace](3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/103-06-020-citizens-of-sigil.webp#center)
