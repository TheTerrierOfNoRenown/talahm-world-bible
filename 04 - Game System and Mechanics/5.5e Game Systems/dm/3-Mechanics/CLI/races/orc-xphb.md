...
You can take the [Dash](actions.md#Dash) action as a [Bonus Action](bonus-action-xphb.md). When you do so, you gain a number of [Temporary Hit Points](temporary-hit-points-xphb.md) equal to your [Proficiency Bonus](proficiency-xphb.md).

You can use this trait a number of times equal to your [Proficiency Bonus](proficiency-xphb.md), and you regain all expended uses when you finish a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md).
...
When you are reduced to 0 [Hit Points](hit-points-xphb.md) but not killed outright, you can drop to 1 [Hit Point](hit-points-xphb.md) instead. Once you use this trait, you can't do so again until you finish a [Long Rest](long-rest-xphb.md).
